        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 text-xs text-muted-foreground">
              <Link to="/about#privacy" className="link-underline hover:text-foreground transition-colors">
                {t("footer.privacy")}
              </Link>
              <Link to="/about#terms" className="link-underline hover:text-foreground transition-colors">
                {t("footer.terms")}
              </Link>
              <Link to="/about" className="link-underline hover:text-foreground transition-colors">
                {t("footer.about")}
              </Link>
            </div>
          </div>
