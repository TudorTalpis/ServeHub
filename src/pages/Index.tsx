...
import { ArrowRight, Search as SearchIcon, TrendingUp, Shield, Clock, Star } from "lucide-react";
    ...
    <div className="animate-fade-in">
            ...
            {!hasRole(["PROVIDER", "ADMIN"]) && (
              <Link to="/become-provider">
                <Button
                  size="lg"
                  variant="outline"
                  className="gap-2 rounded-xl h-12 px-8 text-sm border-border/60 hover:border-primary/40 hover:bg-primary/5 hover:text-primary transition-all"
                >
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:py-16">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            to="/categories"
            className="flex items-center gap-1.5 text-sm text-primary font-medium link-underline hover:text-primary/80 transition-colors"
          >
